...
//edge case: drop onto not a container// the UI is composed of RECTS. 
...
polymorph_core.rects = {};function _topbar(parent, options) {
...
var dateParser = new _dateParser();function __itemlist_searchsort() {
    //search
...
var intervalParser = new _intervalParser();polymorph_core.registerOperator("terminal", {
