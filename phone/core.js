...
function _core() {
    ...
    documentReady(() => {
        ...
        <div id="topbar" style="flex: 0 0 2em">
            ...
            <span class="docName">Polymorph</span>
        </div>
        ...
        me.toggleMenu = function (visible) {
        ...
        document.body.querySelector("#menulist").parentElement.addEventListener("click", (e) => {
            if (e.currentTarget == e.target) {
                me.toggleMenu(false);//hide on direct taps
            }
        })
    })
        ...
        if (me.saveSources[source]) {
            ...
            me.saveSources[source].pullAll(id).then((d) => {
                ...
                if (!d) {
                    ...
                    me.userData.documents[me.currentDocName]={};
                    me.userData.documents[me.currentDocName].autosave=true;// by default make autosave true, so user does not have to save
                    /*if (!tutorialStarted) {
                        core.tutorial.start();
                    }*/
    ...
    */
    ...
    this.filescreen.baseDiv.querySelector(".__fsnewbtn").addEventListener("click",()=>{
        this.filescreen.baseDiv.querySelector("#__fsnew").style.display="block";
    })
